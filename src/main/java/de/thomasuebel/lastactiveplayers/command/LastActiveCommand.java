 ...
 * any {@link CommandSender}. The {@code test} subcommand is gated behind the
 * {@code lastactiveplayers.admin} permission (which defaults to op in {@code plugin.yml}).
 */
